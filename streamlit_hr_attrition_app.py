...
with tab1:
    ...
    predict_btn = st.button("Predict Attrition", type="primary")
...
with tab3:
    ...
    with col_b:
        ...
        if metrics:
            ...
            st.dataframe(make_arrow_safe(metrics_df), use_container_width=True)
        else:
    ...
    if feature_schema:
        ...
        st.dataframe(make_arrow_safe(schema_df),use_container_width=True)
    else:
